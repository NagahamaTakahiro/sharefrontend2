    ...
    <div v-for="(value, index) in shares" :key="index">
      <div class="message">
        <div class="flex">
          ...
          <img class="icon" src="../assets/assets/heart.png" @click="fav(index)" alt />
...
export default {
  ...
  methods: {
      ...
      if (result) {
        this.shares[index].like.forEach((element) => {
          if (element.user_id == this.$store.state.user.id) {
            axios({
              method: "delete",
              url: "https://intense-cove-88098.herokuapp.com/api/like",
              data: {
        ...
        axios
          .post("https://intense-cove-88098.herokuapp.com/api/like", {
            share_id: this.shares[index].item.id,
            user_id: this.$store.state.user.id,
          })
          .then((response) => {
    ...
    del(index) {
      axios
        .delete(
          "https://intense-cove-88098.herokuapp.com/api/shares/" +
